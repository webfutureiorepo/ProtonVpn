...
final class SearchViewModelTests: XCTestCase {
    func testInitialStateIsEmptyWhenNoRecentSearchesArePresent() {
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: [], constants: Constants(numberOfCountries: 61), mode: .standard(.free))
    ...
    func testSearchingInFreeModeShouldContainsUpsell() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: data, constants: Constants(numberOfCountries: 61), mode: .standard(.free))
        vm.search(searchText: "Fra")
    ...
    func testSearchingInStandardModeShouldDoesNotContainUpsell() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: data, constants: Constants(numberOfCountries: 61), mode: .standard(.plus))
        vm.search(searchText: "Fra")
    ...
    func testSearchingSecureCoreCountries() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: data, constants: Constants(numberOfCountries: 61), mode: .secureCore)
    ...
    func testSortingServersForFreeUsers() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: [france], constants: Constants(numberOfCountries: 61), mode: .standard(.free))
    ...
    func testSortingServersForPlusUsers() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: [france], constants: Constants(numberOfCountries: 61), mode: .standard(.plus))
    ...
    func testSearchingCitiesByTranslatedNames() {
        ...
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: [czechia], constants: Constants(numberOfCountries: 61), mode: .standard(.plus))
    ...
    func testSearchingCountriesWithMultipleWords() {
        let us = CountryViewModelMock(country: "United States", servers: [:])
        let vm = SearchViewModel(recentSearchesService: RecentSearchesService(), data: [us], constants: Constants(numberOfCountries: 61), mode: .standard(.plus))
