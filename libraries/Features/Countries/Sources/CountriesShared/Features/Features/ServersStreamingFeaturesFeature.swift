...
@Reducer
public struct ServersStreamingFeaturesFeature {
    @ObservableState
    public struct State: Equatable {
        public let countryName: String
        public var streamingServices: IdentifiedArrayOf<StreamingServiceItem.State>

        public init(countryName: String, streamingServices: IdentifiedArrayOf<StreamingServiceItem.State>) {
...
#if DEBUG
    public extension ServersStreamingFeaturesFeature.State {
