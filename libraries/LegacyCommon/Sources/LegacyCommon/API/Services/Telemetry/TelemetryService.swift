...
public class TelemetryServiceImplementation: TelemetryService {
    public typealias Factory = AppStateManagerFactory & NetworkingFactory & PortForwardingPropertyProviderFactory & TelemetryAPIFactory & TelemetrySettingsFactory & TimerFactoryCreator & VpnKeychainFactory
