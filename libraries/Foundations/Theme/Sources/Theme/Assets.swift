...
public enum Asset {
  ...
  public static let vpnCarbonTextNorm = ColorAsset(name: "VpnCarbonTextNorm")
  public static let vpnCarbonTextWeak = ColorAsset(name: "VpnCarbonTextWeak")
  ...
  public enum Flags {
    ...
    public static let gateway = ImageAsset(name: "Flags/Gateway")
    ...
    public static let mostRecent = ImageAsset(name: "Flags/MostRecent")
    ...
    public static let random = ImageAsset(name: "Flags/Random")
  ...
  public static let freeFlags = ImageAsset(name: "free-flags")
  public static let globeError = ImageAsset(name: "globe-error")
  public static let hermesDragIcon = ImageAsset(name: "hermesDragIcon")
