...
public enum Localizable {
  ...
  public static var hermesConflictHermesOnTitle: String { return Localizable.tr("Localizable", "_hermes_conflict_hermesOn_title", fallback: "Enables ${HERMES}?") }
  ...
  public static var hermesEntitiesFootnote: String { return Localizable.tr("Localizable", "_hermes_entities_footnote", fallback: "If your custom ${HERMES_ENTITY} doesn’t work, the standard VPN ${HERMES_TECHNOLOGY} will be used.") }
