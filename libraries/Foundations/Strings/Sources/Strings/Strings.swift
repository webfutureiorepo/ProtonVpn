...
public enum Localizable {
  ...
  /// iOS: Alert message after account creation in guest mode
  public static var accountCreatedTitle: String { return Localizable.tr("Localizable", "_account_created_title", fallback: "Account created") }
  ...
  /// All servers in this gateway are under maintenance.
  public static var allServersInGatewayUnderMaintenance: String { return Localizable.tr("Localizable", "_all_servers_in_gateway_under_maintenance", fallback: "All servers in this gateway are under maintenance.") }
  /// Under maintenance alert
  ...
  /// iOS: Cancel button on account creation flow
  public static var createAccountCancelUpgrade: String { return Localizable.tr("Localizable", "_create_account_cancel_upgrade", fallback: "Cancel upgrade") }
  /// iOS: Continue button on account creation flow
  public static var createAccountContinueCreating: String { return Localizable.tr("Localizable", "_create_account_continue_creating", fallback: "Continue creating account") }
  /// iOS: Alert title for purchase attempt in guest mode
  ...
  public static var hermesEntitiesFormHeader: String { return Localizable.tr("Localizable", "_hermes_entities_form_header", fallback: "Add new ${HERMES_ENTITY_CAPITALIZED}") }
  /// Hermes entities Form placeholder within dedicated Hermes Settings view
  public static var hermesEntitiesFormPlaceholder: String { return Localizable.tr("Localizable", "_hermes_entities_form_placeholder", fallback: "192.0.2.0") }
  /// Hermes entities Form validation "Duplicate" message within dedicated Hermes Settings view
  public static var hermesEntitiesFormValidationDuplicate: String { return Localizable.tr("Localizable", "_hermes_entities_form_validation_duplicate", fallback: "Server already added") }
  /// Hermes entities Form validation "Enter Address" message within dedicated Hermes Settings view
  public static var hermesEntitiesFormValidationEnterAddress: String { return Localizable.tr("Localizable", "_hermes_entities_form_validation_enterAddress", fallback: "Enter an IPv4 address") }
  /// Hermes entities Form validation "Enter Valid Address" message within dedicated Hermes Settings view
  public static var hermesEntitiesFormValidationEnterValidAddress: String { return Localizable.tr("Localizable", "_hermes_entities_form_validation_enterValidAddress", fallback: "Enter a valid IPv4 address") }
  /// Hermes entities Form validation "Unexpected Error" message within dedicated Hermes Settings view
  public static var hermesEntitiesFormValidationUnexpectedError: String { return Localizable.tr("Localizable", "_hermes_entities_form_validation_unexpectedError", fallback: "An unexpected error occurred.") }
  ...
  public static var hermesUpsellDescription: String { return Localizable.tr("Localizable", "_hermes_upsell_description", fallback: "Connect using a ${HERMES_CUSTOM_ENTITY} with VPN Plus.") }
  /// Hermes Feature Upsell title within dedicated upsell screen
  public static var hermesUpsellTitle: String { return Localizable.tr("Localizable", "_hermes_upsell_title", fallback: "Advanced VPN customization") }
  ...
  /// Text appears as popup after copy action
  public static var pfCopied: String { return Localizable.tr("Localizable", "_pf_copied", fallback: "Copied") }
  ...
  public static var plutoniumCustomizeConnection: String { return Localizable.tr("Localizable", "_plutonium_customize_connection", fallback: "Exclude selected apps from your VPN connection.") }
  ...
  public static var plutoniumExcludeModeDescription: String { return Localizable.tr("Localizable", "_plutonium_exclude_mode_description", fallback: "Allow selected apps to connect without VPN protection.") }
  ...
  /// Description of the split tunneling feature operation mode
  public static var plutoniumIncludeModeDescription: String { return Localizable.tr("Localizable", "_plutonium_include_mode_description", fallback: "Only selected apps connect with VPN protection. All other traffic is unprotected.") }
  ...
  public static var plutoniumTitle: String { return Localizable.tr("Localizable", "_plutonium_title", fallback: "Split tunneling (experimental)") }
  ...
  /// Connect to a P2P server to improve torrenting speeds
  public static var quickSettingsPortForwardingWarningNote: String { return Localizable.tr("Localizable", "_quick_settings_portForwarding_warningNote", fallback: "Connect to a P2P server to improve torrenting speeds") }
  ...
  /// Lets you exclude trusted apps from your VPN connection. Plus feature.
  public static var sysexTutorialFeatureSt: String { return Localizable.tr("Localizable", "_sysex_tutorial_feature_st", fallback: "Lets you exclude trusted apps from your VPN connection. Plus feature.") }
  ...
  public static var splitTunnelingAlertDescription: String { return Localizable.tr("Localizable", "split_tunneling_alert_description", fallback: "Split tunneling is not compatible with the IKEv2 protocol.") }
  ...
  /// Description of alert shown if user tries to connect to an IKEv2 profile and split tunneling is enabled. The 'Learn More' text is a hyperlink to https://protonvpn.com/support/protonvpn-split-tunneling#macos
  ...
  /// The text inside the IKEv2 & Split Tunneling conflict alert. It will be displayed as a hyperlink to https://protonvpn.com/support/protonvpn-split-tunneling#macos
  public static var splitTunnelingConnectToProfileAlertLink: String { return Localizable.tr("Localizable", "split_tunneling_connect_to_profile_alert_link", fallback: "Learn more") }
