...
- Ensure you clone submodules (`git submodule init` + `git submodule update`)
...
These files are kept in a separate repository, which requires some additional setup to keep synchronized.
